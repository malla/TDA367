...
public class TestBoard {
	...
	public void testInit() {
		...
		// assertTrue(b.getMission() == null && b.getActivePieceNumber() == 0 &&
		// b.getNumberOfPieces() == 3);
	...
	/*
	 * Since setActiveTurn() only is applicable when the game initializes the active piece will not actually change 
	 * and the active piece will still have index 0.
	 */
	@Test
	public void testSetActivePiece() {
		
		Board b = Board.getInstance();
		b.setActivePiece(0);
		System.out.println(b.getActivePiece().getIndex()+"");
		assertTrue(b.getActivePiece().getIndex() == 0);
		b.setActivePiece(1);
		System.out.println(b.getActivePiece().getIndex()+"");
		assertTrue(b.getActivePiece().getIndex() == 0);
	}
	...
	/*
	 * Not able to test since as soon as you call getInstance you create a  new board
	 */
	@Test
