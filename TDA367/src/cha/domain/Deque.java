...
public class Deque {
	...
	static String[][] sameClasses = {
					...
					"Bosch", "Asus", "Acer", "HP", "Toshiba", "dell", "LG" },
			{
					...
					"postIT", "doIT", "6IT", "ruleIT", "findIT", "dITo",
					"bITter", "moveIT", "sexIT", "P.R.I.T.", "NollkIT",
					"drawIT", "digIT", "styrIT" },
			{ "Which are countries in Asia?", "Yemen", "Indonesia", "India",
					"Thailand", "China", "Burma", "Korea", "Japan", "Ireland",
					"England", "Australia", "United States", "Estonia",
					"Sweden" },
			{ "Which are countries that start with a vocal?", "England",
					"Ireland", "Italy", "Estonia", "United States",
					"Australia", "Indonesia", "India", "Thailand", "China",
					"Korea", "Burma", "Japan", "Vietnam" },
			{ "Which are countries in Europe?", "Sweden", "Spain", "England",
					"France", "Italy", "Norway", "Estonia", "Portugal",
					"United States", "Mexico", "New Zeeland", "Chile", "Yemen",
					"Canada" },
			{ "Which do not have to be a relative?", "girl", "person",
					"friend", "collaegue", "boss", "celebrity", "doctor",
					"friend", "mother", "sister", "niece", "aunt", "ancestor",
					"relative" },
			{ "Which can be used as a vessel to transport a person?",
					"a plane", "zepelin", "helicopter", "a car", "a ferry",
					"a truck", "a metro", "a caravan", "a station", "a wheel",
					"a brake", "a platform", "an engine", "a stop sign" },
			{ "Which might you logically look to see in the sky?", "the sun",
					"a bird", "the moon", "a plane", "a baloon", "stars",
					"zepelin", "helicopter", "flowers", "the earth", "a dog",
					"hearts", "circles", "a car" },
			{ "Which are commonly used to communicate?", "telephone",
					"computor", "blinkers", "letters", "signs", "talking",
					"emails", "gestures", "mixer", "clothes",
					"self-reminder notes", "sink", "running", "tables" },
			...
			{ "Which are sports without a ball?", "Sailing", "Racing",
					...
					"Swimming", "Cricket", "Basket", "Golf", "Tennis",
					"Badminton", "Football" },
			...
			{ "Which animals spend a lot of time in water?", "Dolphin",
					...
					"Tortoise", "Salmon", "Lion", "Horse", "Cow",
	...
	private Card getJumbleCard(String word, int bet) {
		...
		String[] info = new String[] { "Find a word with at least " + bet
				+ " letters!\n" + jumbled.toString() };
	...
	private List<Card> getBackwards(int bet) {
		...
		for (int j = 0; j < bet; j++) {
			...
			allCards.add(new Card(
					new String[] { "The right answer is: " + word }));
		}
		return allCards;
	}
	...
	/*
	 * Returns a random word from ArrayList words, and then removes it from that
	 * ArrayList
	 */
