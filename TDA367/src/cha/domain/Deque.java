...
public class Deque{
	...
	static String[][] sameClasses = {
		{"Which are sports?",
			"Football", "Tennis", "Icehockey", "Basketball", "Swimming", "Golf", "Badminton", "Running", "Photography", "Writing", "Drawing", "Reading","Sleeping", "Loving"},
		{"Which things are sweet?", 
				"Honey", "Sugar", "Cupcake", "CocaCola", "Sweet", "Lollipop", "IceCream", "Chocolate", "Meat", "Fish", "Pasta", "Chili", "Rice", "Salt"},
		{"Which names are male?", 
					"Per", "Ola", "Bert", "Oliver", "Nicklas", "Robin", "Dennis", "Hugo", "Sara", "Olivia", "Pernilla", "Hedvig","Berit", "Signe"},
		{"Which are kitchen appliances", 
					"Stove", "Mixer", "Frigde", "Microwave", "Fryingpan", "Oven", "Pot", "Tv", "Sofa", "Blanket", "Remote","Painting", "Chair"},
		{"Which are desserts?", 
					"Spunge cake", "Macaroon", "Icecream", "Tapioca pudding", "Cranberry pie", "Chocolate chip cookies", "Shortcake", "Apple pie", "Bouillabaisse", "Fish cake", "Fish and chips", "Sausage","Chicken wings", "French fries"},
		{"Which are red?", 
					"Strawberrie", "Tomatoe", "Lady bug", "Ketchup", "Rose", "Lipstick", "Cranberry", "Stop sign", "Blueberry", "Orange", "Cucumber", "Pea", "Rice", "Leaf"},
		{"Which are school subjects?", 
					"Math", "English", "Arts and crafts", "Biology", "Science", "Physical education", "Geography", "History", "Football", "DJ:ing", "Ballet", "Twirling","Jumping", "Sitting"},
		{"Which are clothing stores?",
						"Zara", "H&M", "GinaTricot", "BikBok", "Solo", "Design only", "JC", "Tara", "Kappahl", "Ica", "Clas Ohlson", "Body shop","Lidel", "Kicks"},
		{"Which are drinks?", 
					"Fanta", "CocaCola", "Cider", "Water", "Jucie", "Tea", "Coffe", "7up", "Concrete", "Wood", "Salmon", "Plastic", "Parrot", "Whale"},
